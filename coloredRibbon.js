function createRibbons(sendBuilder = {}) {
...
function build() {
    ...
    var Factory = function (options) {
        ...
        this._options = {
            colorSaturation: "80%",
            colorBrightness: "60%",     //控制颜色变化
            colorAlpha: builder.colorAlpha,
            colorCycleSpeed: builder.colorCycleSpeed,
            verticalPosition: "center", //中心点
            horizontalSpeed: builder.horizontalSpeed,       //可以在这调整速度
            ribbonCount: builder.ribbonCount,             //同一Tick的彩带数
    ...
    Factory.prototype = {
        constructor: Factory, setOptions: function (options) {
            ...
            try {
                ...
                this._canvas.style["background-color"] = builder.color; //基础背景颜色
